...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 25, 2020 at 06:27 PM
...
--
ALTER TABLE `transaction`
  ADD CONSTRAINT `transaction_ibfk_1` FOREIGN KEY (`senderId`) REFERENCES `user` (`userId`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
